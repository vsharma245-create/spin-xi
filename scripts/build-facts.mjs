...
const facts = {
   ...
   * No build timestamp.
   *
   * This file is regenerated by every build, and stamping the time meant it
   * came back modified every single time even when not one figure had changed
   * — a permanently dirty working tree, which is a good way to stop noticing
   * real changes in it. The figures move when the archive moves, and that is
   * the only reason this file should ever move.
   */
  counts: {
    matches: 15270,
